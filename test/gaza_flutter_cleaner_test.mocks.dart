...
class MockProjectValidator extends _i1.Mock implements _i6.ProjectValidator {
  ...
  _i4.Future<bool> validateProject({
    ...
    required List<_i2.File>? filesToCheck,
      ...
      (super.noSuchMethod(
            Invocation.method(#validateProject, [], {
              #directory: directory,
...
class MockDirectoryHelper extends _i1.Mock implements _i7.DirectoryHelper {
  ...
  _i4.Future<double> calculateDirectorySize({
    required _i2.Directory? directory,
      ...
      (super.noSuchMethod(
            Invocation.method(#calculateDirectorySize, [], {
              #directory: directory,
            }),
  ...
  _i4.Future<List<_i2.Directory>> getAllSubDirectories({
    required _i2.Directory? directory,
      ...
      (super.noSuchMethod(
            Invocation.method(#getAllSubDirectories, [], {
              #directory: directory,
            }),
            returnValue: _i4.Future<List<_i2.Directory>>.value(
              <_i2.Directory>[],
            ),
            returnValueForMissingStub: _i4.Future<List<_i2.Directory>>.value(
              <_i2.Directory>[],
            ),
          )
